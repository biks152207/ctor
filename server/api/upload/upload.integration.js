...
describe('Upload API:', function() {
  ...
  describe('PUT /api/uploads/:id', function() {
    ...
    it('should respond with the original upload', function() {
      expect(updatedUpload.name).to.equal('New Upload');
      expect(updatedUpload.info).to.equal('This is the brand new upload!!!');
    });
